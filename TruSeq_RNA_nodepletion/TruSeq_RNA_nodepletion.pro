		...
		<Main_Processes >
			...
			<Process >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						<Parameter Category='' Name='Title' Value='Plate transfer' />
						<Parameter Category='' Name='Body' Value='Remove the plate in position 4. Seal, transfer to a thermocycler and run the cDNA first strand synthesis program. Seal the Deep well nunc plate with reagents on position 9 and store it in 4慢. Click &quot;Continue&quot; when incubation has started.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
